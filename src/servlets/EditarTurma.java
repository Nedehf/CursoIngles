...
public class EditarTurma extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out.println("body, h1, h2, h3, h4, h5, h6 {	font-family: \"Montserrat\", sans-serif" + "}" +
				...
				"/* Set the width of the sidebar to 120px */" + ".w3-sidebar { width: 120px; background: #222; }" +
		...
		out.println("<!-- Campos -->" + "<p>Altere o campo a ser modificado abaixo:</p>" +

				"<form action=\"AtualizarTurma\" method=\"post\">");

		out.println("<!-- Codigo da Turma -->" + "<p>"
				+ "<input class=\"w3-input w3-padding-16 w3-border\" type=\"text\" placeholder=\"Código da Turma\" required name=\"codigo\" value=\""
				+ t.getCodigo() + "\">" + "</p>");

		out.println("<!-- Professor -->" + "<p>"
				+ "	<input class=\"w3-input w3-padding-16 w3-border\" type=\"text\"	placeholder=\"Professor\" required name=\"professor\" value=\""
				+ t.getProfessor() + "\">" + "	</p>");
		...
		for (int j = 0; j < horarios.length; j++) {
			...
			if (t.getHorario().equals(horarios[j])) {
				...
				out.println("<option class=\"w3-input w3-padding-16 w3-border\" value=\"" + horarios[j] + "\">"
						+ hrInfo[j] + "</option>");
			}
		}
		...
		out.println("<!-- Numero da Sala -->" + "<p>"
				+ "<input class=\"w3-input w3-padding-16 w3-border\" type=\"text\" placeholder=\"Número da Sala\" required name=\"sala\" value=\""
				+ t.getSala() + "\">" + "</p>");

		out.println("<!-- Qtde de Alunos -->" + "<p>"
				+ "<input class=\"w3-input w3-padding-16 w3-border\" type=\"text\" placeholder=\"Quantidade máxima de alunos\" required name=\"quantidade\" value=\""
				+ t.getQtde_maxima() + "\">" + "</p>");
